...
const Blog = () => {
    return (
        <div>
            ...
            <div className='my-7'>
                <h1 className='text-4xl fontt-bold mb-2'>What is a custom hook?</h1>
            ...
            <div className='my-7'>
                <h1 className='text-4xl fontt-bold mb-2'>What is useRef?</h1>
            ...
            <div className='my-7'>
                <h1 className='text-4xl fontt-bold mb-2'>What is useMemo?</h1>
